                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12" align="right">
                        <a class="btn btn-primary" href="<?php echo base_url('add/category')?>" type="button"><i class="fa fa-plus"></i> Add Category</a>
                    </div>
                        ...
                        foreach ($all_categroy as $single_category) {
                            ...
                            <tr class="<?php echo ($i%2) ? 'even':'odd' ?> pointer">
                                ...
                                <td class="center">
                                    ...
                                    <?php } else {
                                        ?>
                                        <a class="btn btn-primary" href="<?php echo base_url('unpublished/category/' . $single_category->id); ?>">
