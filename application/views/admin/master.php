        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo base_url() ?>dashboard" class="site_title"><i class="fa fa-paw"></i> <span>Dashboard</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <li><a href="<?php echo base_url('manage/category')?>"><i class="fa fa-archive"></i> Category </a></li>
                <li><a href="<?php echo base_url('manage/brand')?>"><i class="fa fa-laptop"></i> Brand </a></li>
                <li><a href="<?php echo base_url('manage/product')?>"><i class="fa fa-database"></i> Product </a></li>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo base_url() ?>/assets/admin/images/img.jpg" alt=""><?php echo $this->session->userdata('user_name');?>
                  </a>
